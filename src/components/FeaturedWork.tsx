...
const PROJECTS = [
  { name: "The Atomic Growth Club", tag: "Influencer campaigns" },
  { name: "Feathered Lane Studios", tag: "Social strategy & creation" },
  { name: "The Lazy Cow Cocktails", tag: "Social strategy & creation" },
];
